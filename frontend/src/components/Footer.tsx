        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="max-w-sm text-gray-400">Empowering citizens to create positive change in their communities through effective communication with complaints or feedback.</p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><Link to="/contact" className="hover:text-white">Contuct Us</Link></li>
